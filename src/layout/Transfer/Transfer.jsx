...
const Transfer = () => {
  ...
  const [montoinval,setMontoinval] = useState('hidden')
        ...
        <div className={`p-6 mt-0 ${state}`}>
          ...
          <form className="z-0" onSubmit={enviarTransferencia}>
            <div className="flex justify-center items-center flex-col">
              ...
              <span className= {`${montoinval} text-bold text-lg text-center mt-6` }>Lo sentimos! El monto ingresado es inválido  😐</span>
            </div>
          </form>
        </div>
      </div>
